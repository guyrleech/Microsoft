...
Function Get-NTFSLongOrShortName()
{
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        ...
        Get-NTFSLongOrShortName -path c:\progra~1,c:\progra~2 

        Convert the two given 8.3 NTFS short names to their long names

    .EXAMPLE

        Get-NTFSLongOrShortName -path 'C:\Program Files','C:\Program Files (x86)' -toShort
    ...
    .NOTES
        ...
        Dot source this file to use Get-NTFSLongOrShortName
    #>
